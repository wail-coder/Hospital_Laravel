...
<div class="p-5">
    ...
    <div class="mt-8 p-4">
        <form method="POST" action="{{ route('buildings.storeSecondStep', $hospital->id) }}">
            @csrf
            <div>
            ...
            @for ($i = 1; $i <= $floor_number; $i++)
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="w-full mx-2 flex-1 svelte-1l8159u">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase">Floor Number</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                            <input name="floor_number[]"  placeholder="B2,B1,G,1,..."  class="p-1 px-2 appearance-none outline-none w-full text-gray-800" required autofocus> </div>
                    </div>
                    <div class="w-full mx-2 flex-1 svelte-1l8159u">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase">Floor Name</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                            <input name="floor_name[]"  placeholder="basement,first,..." class="p-1 px-2 appearance-none outline-none w-full text-gray-800" required autofocus> </div>
                    </div>
                    <div class="w-full mx-2 flex-1 svelte-1l8159u">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase">Location</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                            <input name="floor_location[]"  placeholder="North,South,..." class="p-1 px-2 appearance-none outline-none w-full text-gray-800" required autofocus> </div>
                    </div>
                    <div class="w-full mx-2 flex-1 svelte-1l8159u">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase">Number of Room</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                            <input name="room_number[]"  placeholder="1,2,3,....,20" type="number" min="1" max="20" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" required autofocus> </div>
                    </div>
                </div>
