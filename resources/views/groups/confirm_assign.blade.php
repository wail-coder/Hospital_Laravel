...
<div class="p-5">
    <div class="mx-3 p-4">
        ...
        <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 bg-green-600  border-green-600">
            ...
            <div class="flex items-center text-white relative">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-green-600 text-bold">Rooms Information</div>
            </div>
            <div class="flex-auto border-t-2 transition duration-500 ease-in-out bg-green-600 border-green-600"></div>
    ...
    <form method="POST" action="{{ route('groups.storeAssignConfirmStep', $groups->id) }}">
            @csrf
    <div class="mt-8 p-4">
    <h3 class="text-xl text-gray-700 mb-2 font-bold" >Rooms Information</h3>
    <div class="flex flex-col">
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
        ...
        <div class="flex p-2 mt-4">
            ...
            border-green-600 transition">Confirm</button>
                </div>
            </div>
            </form>
