...
<div class="p-5">
    <div class="mx-3 p-4">
        ...
        <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-green-600">
            ...
            <div class="flex items-center text-gray-500 relative">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase ext-green-600 text-bold">Floors Information</div>
            </div>
            <div class="flex-auto border-t-2 transition duration-500 ease-in-out"></div>
            <div class="flex items-center text-gray-500 relative">
                <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-gray-300">
    ...
    <div class="mt-8 p-4">
    <form method="POST" action="{{ route('groups.storeAssignFirstStep', $groups->id) }}">
            @csrf
            <div class="flex flex-col">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr  id="hideShowFloor_{{ $building->id }}" >
              <!-- <input type="hidden" name="user_id[]" value="{{ $user->id }}"> -->
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <input type="checkbox" name="building_value[]" class="form-checkbox h-5 w-5 text-gray-600" value="{{$building->id}}" id ="building_{{ $building->id }}" href="#hideShowFloor_{{ $building->id }}"  onclick="showhide(this)"> 
