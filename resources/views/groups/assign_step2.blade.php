...
<div class="p-5">
    ...
    <div class="mt-8 p-4">
    <form method="POST" action="{{ route('groups.storeAssignSecondStep', $groups->id) }}">
            @csrf
            <div class="flex flex-col">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <!-- <input type="hidden" name="user_id[]" value="{{ $user->id }}"> -->
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <input type="checkbox" name="floor_value[]" class="form-checkbox h-5 w-5 text-gray-600" value="{{$floor->id}}" id ="floor_{{ $floor->id }}" href="#hideShowFloor_{{ $floor->id }}"  onclick="showhide(this)"> 
