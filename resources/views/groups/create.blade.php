...
<div class="p-5">
    <div class="mx-3 p-4">
        <div class="flex items-center">
            ...
            <div class="flex items-center text-gray-500 relative">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-gray-500">Member Information</div>
            </div>
            <div class="flex-auto border-t-2 transition duration-500 ease-in-out"></div>
            <div class="flex items-center text-gray-500 relative">
                <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-gray-300">
    ...
    <div class="mt-8 p-4">
    <form method="POST" action="{{ route('groups.storeFirstStep') }}">
            @csrf
            <div>
        <x-jet-validation-errors class="mb-4" />
                <div class="flex flex-col md:flex-row">
                    <div class="w-full mx-2 flex-1 svelte-1l8159u">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase">Group Number</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                            <input name="group_number" :value="old('group_number')" placeholder="1,2,3,100" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" required autofocus> </div>
                    </div>
                    <div class="w-full mx-2 flex-1 svelte-1l8159u">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase">Group Name</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                            <input name="group_name" :value="old('group_name')" placeholder="group pediatric,group obstetrics,..." class="p-1 px-2 appearance-none outline-none w-full text-gray-800" required autofocus> </div>
                    </div>
                </div>
            </div>
