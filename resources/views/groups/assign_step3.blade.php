...
<!-- <div class="flex flex-wrap space-x-5 -mx-1 overflow-hidden bg-white border border-gray-300"> -->
    ...
    <div class="mt-8 p-4">
    <h3 class="text-xl text-gray-700 mb-2 font-bold" >Group Members</h3>
...
<div class="p-5">
    <div class="mx-3 p-4">
        ...
        <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 bg-green-600  border-green-600">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-green-600 text-bold">Buildings Information</div>
            </div>
            ...
            <div class="flex items-center text-white relative">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-green-600 text-bold">Floors Information</div>
            </div>
            <div class="flex-auto border-t-2 transition duration-500 ease-in-out bg-green-600 border-green-600"></div>
            <div class="flex items-center text-green-600 relative">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase ext-green-600 text-bold">Rooms Information</div>
            </div>
    ...
    <div class="mt-8 p-4">
    <form method="POST" action="{{ route('groups.storeAssignThirdStep', $groups->id) }}">
            @csrf
            <div class="flex flex-col">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <!-- <input type="hidden" name="user_id[]" value="{{ $user->id }}"> -->
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <input type="checkbox" name="room_value[]" class="form-checkbox h-5 w-5 text-gray-600" value="{{$room->id}}" id ="room_{{ $room->id }}" href="#hideShowroom_{{ $room->id }}"  onclick="showhide(this)"> 
